    ...
    <div>
            ...
            <div className="w-[30%] bg-white rounded-3xl shadow-lg px-8 py-8 fade-in max-sm:w-[85%] max-md:w-[70%] max-lg:w-[50%] max-xl:w-[40%]">
              <div className='space-y-2'>
                ...
                <div className="flex space-x-1.5">
                  ...
                  <button type='button' className='w-full py-2 text-sm text-white duration-300 rounded-lg cursor-pointer border-NuBlue bg-NuBlue hover:bg-NuLightBlue' onClick={onSubmit} disabled={isSubmitted}>Confirm</button>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="relative w-full max-sm:text-sm">
        <div className="flex justify-between rounded-lg text-ellipsis overflow-hidden whitespace-nowrap border-2 border-[#93adc2] py-1 px-2 mt-3 max-sm:py-0.5 max-sm:px-0.5">
          <button type='button' onClick={() => setIsOpen(!isOpen)} className='flex justify-between w-full px-4 py-2 cursor-pointer'>
          ...
          <button className='cursor-pointer text-white text-sm py-2.5 px-14 bg-NuBlue rounded-md shadow-md duration-300 hover:bg-NuLightBlue hover:scale-105' onClick={() => setConfirm(true)}>Apply</button>
        </div>
